...
public class SNMPTrapperConfigTest {

	private SNMPTrapperConfig config;

	@Before
	public void setUp() throws Exception {
		config = new SNMPTrapperConfig();
	...
	@Test
	public void testGetTrapperProtocol() {
		assertEquals("udp", config.getTrapperProtocol());
	}

	@Test
	public void testGetTrapperServer() {
		assertEquals("127.0.0.1", config.getTrapperServer());
	}

	@Test
	public void testGetTrapperPort() {
		assertEquals(162, config.getTrapperPort());
	}

	@Test
	public void testGetTrapperCommunity() {
		assertEquals("public", config.getTrapperCommunity());
	}

	@Test
	public void testGetTrapperVersion() {
		assertEquals("v1", config.getTrapperVersion());
	}

	@Test
	public void testGetTrapperEnterprise() {
		assertEquals("1.3.6.1.4.1.35437.1.1.2425.2011", config.getTrapperEnterprise());
	}
