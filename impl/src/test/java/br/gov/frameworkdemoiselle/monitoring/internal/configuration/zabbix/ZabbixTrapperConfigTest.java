...
public class ZabbixTrapperConfigTest {
	...
	public void setUp() throws Exception {
		config = new ZabbixTrapperConfig();
	...
	public void testGetTrapperServer() {
		assertEquals("localhost", config.getTrapperServer());
	}

	@Test
	public void testGetTrapperPort() {
		assertEquals(10051, config.getTrapperPort());
	}

	@Test
	public void testGetTrapperHost() {
		assertEquals("Host Name on Zabbix", config.getTrapperHost());
	}

	@Test
	public void testGetTrapperDefaultKey() {
		assertEquals("app.message", config.getTrapperDefaultKey());
	}

	@Test
	public void testIsActiveChecks() {
		assertFalse(config.isActiveChecks());
	}
