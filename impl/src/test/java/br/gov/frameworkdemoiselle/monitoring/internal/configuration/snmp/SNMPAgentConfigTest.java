...
public class SNMPAgentConfigTest {
	...
	@Test
	public void testGetAgentProtocol() {
		assertEquals("udp", config.getAgentProtocol());
	}

	@Test
	public void testGetAgentPort() {
		assertEquals(1161, config.getAgentPort());
	}

	@Test
	public void testGetMibRoot() {
		assertEquals("1.3.6.1.4.1.35437.1.1.2425.2011", config.getMibRoot());
	}

	@Test
	public void testGetSecurity() {
		assertEquals(SNMPAgentConfig.DEFAULT_AGENT_SECURITY, config.getSecurity());
	}
