...
public class ApplicationTrapperExecution {
	...
	@Test
	public void sendQtdTurmas() throws InterruptedException {
		for (int i = 0; i < 5; i++) {
			trapper.sendQtdTurmasIncluidas(42 * (i + 1));
			Thread.sleep(1000);
		}
	}
	
	@Test
	public void sendFailureOnTryBlock() {
		try {
	...
	@Test
	public void sendSystemLoadAvg() throws InterruptedException {
		for (int i = 0; i < 5; i++) {
