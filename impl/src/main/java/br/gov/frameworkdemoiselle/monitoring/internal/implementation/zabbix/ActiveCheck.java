...
/**
 * Holds the information for a single <b>active check</b>.
 * 
 * @author SERPRO
 */
public class ActiveCheck {
	...
	public ActiveCheck(String hostname, String key, int refreshInterval, long lastLogSize) {
	...
	public String toString() {
		return "ActiveCheck [hostname=" + hostname + ", key=" + key
				+ ", refreshInterval=" + refreshInterval + ", lastLogSize="
				+ lastLogSize + "]";
	}
