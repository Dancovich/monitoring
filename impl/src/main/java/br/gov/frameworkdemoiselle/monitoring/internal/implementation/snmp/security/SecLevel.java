...
/**
 * Handles the <b>security level</b> for SNMP (i.e., authentication and or privacy).
 * 
 * @author SERPRO
 */
public enum SecLevel {
	...
	public static SecLevel parsePair(boolean auth, boolean priv) {
		if (auth) {
			if (priv) {
				return AUTH_PRIV;
			} else {
